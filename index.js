...
(function () {
    ...
    const DEFAULT_TABLES_ROLEPLAY = [
        { n: '日常对话', c: ['#日期', '具体内容', '心情/情绪', '身体状态'] },
        { n: '重要事件', c: ['#日期', '#事件类型', '具体内容', '结果/后续', '提及次数', '权重'] },
        { n: '重要时刻', c: ['#日期', '#时刻标签', '具体内容', '提及次数', '权重'] },
        { n: '关于我', c: ['#类型', '#类别', '#日期', '具体内容', '定义', '提及次数', '权重', '等级'] },
        { n: '人物关系', c: ['#日期', '#年龄', '#身份', '性格', '与用户的关系', '备注'] },
        { n: '我们的关系', c: ['#日期', '关系变化', '原因/触发事件', '好感度', '称呼变化'] },
        { n: '承诺约定', c: ['#日期', '具体内容', '责任人', '完成状态', '截止日期'] },
        { n: '待办事项', c: ['#日期', '具体内容', '截止日期', '状态'] },
        { n: '物品追踪', c: ['#日期', '#物品名称', '物品描述', '持有者', '状态', '重要程度', '备注'] },
        { n: '深度认知', c: ['#类型', '#日期', '定义', '具体内容', '判断原因', '置信程度'] },
        { n: '记忆总结', c: ['#表格类型', '总结内容'] }
    ];
    ...
    const DEFAULT_COL_WIDTHS = {
        // 0号表：日常对话
        0: { '#日期': 90, '具体内容': 200, '心情/情绪': 100, '身体状态': 100 },
        // 1号表：重要事件
        1: { '#日期': 90, '#事件类型': 100, '具体内容': 200, '结果/后续': 150, '提及次数': 60, '权重': 60 },
        // 2号表：重要时刻
        2: { '#日期': 90, '#时刻标签': 100, '具体内容': 200, '提及次数': 60, '权重': 60 },
        // 3号表：关于我
        3: { '#类型': 80, '#类别': 80, '#日期': 90, '具体内容': 150, '定义': 150, '提及次数': 60, '权重': 60, '等级': 40 },
        // 4号表：人物关系
        4: { '#日期': 90, '#年龄': 40, '#身份': 80, '性格': 100, '与用户的关系': 120, '备注': 150 },
        // 5号表：我们的关系
        5: { '#日期': 90, '关系变化': 120, '原因/触发事件': 150, '好感度': 60, '称呼变化': 100 },
        // 6号表：承诺约定
        6: { '#日期': 90, '具体内容': 200, '责任人': 80, '完成状态': 80, '截止日期': 90 },
        // 7号表：待办事项
        7: { '#日期': 90, '具体内容': 200, '截止日期': 90, '状态': 60 },
        // 8号表：物品追踪
        8: { '#日期': 90, '#物品名称': 100, '物品描述': 150, '持有者': 80, '状态': 60, '重要程度': 60, '备注': 120 },
        // 9号表：深度认知
        9: { '#类型': 80, '#日期': 90, '定义': 150, '具体内容': 150, '判断原因': 150, '置信程度': 60 },
        // 10号表：记忆总结
        10: { '#表格类型': 100, '总结内容': 300 }
    };
